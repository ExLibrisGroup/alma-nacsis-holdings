...
export class EditFormComponent implements OnInit {
  ...
  private initEditFieldsMap(record): void {
    ...
    this.editFieldsMap.set(FieldName.ILLSTAFF, new SearchField(FieldName.ILLSTAFF, FieldSize.medium, record.fullRecord.fullView.ILLSTAFF, false));
    this.editFieldsMap.set(FieldName.ADDRESS, new SearchField(FieldName.ADDRESS, FieldSize.medium, record.fullRecord.fullView.ADDRESS, false));
    this.editFieldsMap.set(FieldName.ILLDEPT, new SearchField(FieldName.ILLDEPT, FieldSize.medium, record.fullRecord.fullView.ILLDEPT, false));
  ...
  save() {
    ...
    this.member.ILLSTAFF = this.editFieldsMap.get(FieldName.ILLSTAFF).formControl.value;
    this.member.ADDRESS = this.editFieldsMap.get(FieldName.ADDRESS).formControl.value;
    this.member.ILLDEPT = this.editFieldsMap.get(FieldName.ILLDEPT).formControl.value;
